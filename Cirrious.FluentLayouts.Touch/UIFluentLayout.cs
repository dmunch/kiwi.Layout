...
{
    public class UIFluentLayout : FluentLayout<NSObject>
    {
        public UIFluentLayout(
            NSObject view,
        ...
        public UIFluentLayout(NSObject view,
                            NSLayoutAttribute attribute,
                            NSLayoutRelation relation,
                            float constant = 0f)
        {
        ...
        public UIFluentLayout SetPriority(UILayoutPriority priority)
        {
        ...
        private UIFluentLayout SetSecondItem(NSObject view2, NSLayoutAttribute attribute2)
        {
